...
def rot13(message):
    ...
    for c in message:
        if c.isalpha():
            if c.isupper():
                rot13_i = alph_up.index(c)+13 if alph_up.index(c)+13 < 26 else alph_up.index(c)+13-26
                new_message += alph_up[rot13_i]
            elif c.islower():
                rot13_i = alph_lw.index(c)+13 if alph_lw.index(c)+13 < 26 else alph_lw.index(c)+13-26
